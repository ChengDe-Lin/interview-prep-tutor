...
export const guidePages: GuidePage[] = [
  ...
  },
  {
    ...
    points: [
      ...
      { cue: '真正的 platform 問題', text: <>More importantly, this could not continue if we wanted the product to become a platform. If every internal team, hospital developer, or outside partner had to understand and change one huge application just to add a feature, <mark className="concept">the developer community could never grow</mark>.</> },
      ...
      { cue: '先證明再爭取', text: <>I first built small working examples to show that the design could work. I used those results to explain the value to senior leaders and the engineering and PM managers. They agreed to give the migration the time and people it needed.</> },
