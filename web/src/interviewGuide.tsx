...
export const guidePages: GuidePage[] = [
  ...
  },
  {
    ...
    points: [
      ...
      { cue: 'xDesign 實際成果', text: <>At the moment, xDesign has completed <mark className="metric">around 15 to 20 validated design tasks</mark>. We deliberately started with relatively well-understood interaction patterns, and within that validated scope, our designers estimate <mark className="metric">roughly 90% less manual effort</mark>.</>, note: '90% 只限目前 15–20 個 validated、well-understood interaction patterns。' },
      { cue: '收尾', text: <>The biggest lesson for me was that the goal is not to build the most autonomous agent possible. It is to <mark className="outcome">keep following where the real bottleneck moves</mark>, preserve the right human judgment, and turn the repeatable parts into explicit, observable, and controllable systems.</> },
    ],
