...
export const guidePages: GuidePage[] = [
  ...
  },
  {
    ...
    points: [
      ...
      { cue: '產品已到極限', text: <>Our outpatient product had grown into a very large frontend used across many areas of healthcare and many workflows. As we kept adding features to the same app, a change in one area often broke something unrelated. Builds and deployments took longer, and new engineers needed more time to understand the code.</> },
